...
@Component({
  selector: 'app-map-partner-global',
  templateUrl: './map-partner-global.component.html',
  styleUrls: ['./map-partner-global.component.scss'],
})
export class MapPartnerGlobalComponent implements OnInit {
...
// Create an array of alphabetical characters used to label the markers.
  ...
  constructor(public cityService: CityService,
    private pharmGuardServ: PharmacyGuardService,
  ...
  ngOnInit() {
    ...
    navigator.geolocation.getCurrentPosition((position) => {
      ...
      this.markers = this.locations.map((location, i) => new google.maps.Marker({
        position: location,
  ...
  const paysSelected =localStorage.getItem("paysSelect");
    ...
    // Add positions shop
         const pointe = this;
      this.pharmGuardServ.getpharmacyGuard(null,null).then(
        (donnee) => {
        //console.log(donnee);
          donnee.forEach((doc)=>
          {
  ...
  addPositionShop(latd: number, long: number, icone: string, titre: string, data: any) {
   ...
   this.markers.push(
    ...
    // this.markers= new Set(this.markersFull);
