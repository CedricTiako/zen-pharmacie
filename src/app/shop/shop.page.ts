...
import {ServiceAvailable} from '../models/service-available';
import {CommunFunctionService} from '../services/CommunFunctions/commun-functions.service';
...
export class ShopPage implements OnInit {
 ...
 slideOptsflip = {
  ...
  listeServiceMTN = [];
  listeServiceMoMo = [];
  listeCategorie: CategoryPartner[];
  typeAffichage = 'carte';
  ...
  thenBlock: TemplateRef<NgIfContext<boolean>>;


  elseBlock: TemplateRef<NgIfContext<boolean>>;

  constructor(public currentServ: CommunFunctionService,private activatedRoute: ActivatedRoute,private partnerService: PartnerService,private articleService: ArticleService,private cityService: CityService,private countriesServ: ContriesService) { 
  ...
  if(paysSelect!=null){
   this.getCitiesByCountriesIso2(paysSelect);
     //console.log(this.cities);
  }
  else{
   this.countriesServ.getLocation().subscribe(
     (value: any)=>{
         //console.log(value);
        this.getCitiesByCountriesIso2(value.country_code2);
         //console.log(this.cities);
     }
   );
  ...
  ngOnInit() {
    ...
    // this.cityId= ;
    this.cityId = this.activatedRoute.snapshot.params.city;
    ...
    // }
    // else{
    //   this.getCitiesByCountriesIso2('CM');
    //   //console.log(this.cities);
    // }
    // //console.log(this.cities);
  }
 
  setCity(idCity: string)
  {
    //console.log(idCity);
    this.cityId=idCity;
    this.currentServ.redirectTo("tabs/shop/"+this.cityId);
 
        // this.currentServ.router.navigate(['tabs/shop'], { queryParams: { city: this.cityId } });
        // this.reload();
